...
class Layout extends HtmlFacade{
	...
	public static function loadChart()
	{
		static::instance()->addStyle( '/public/plugins/nvd3/nv.d3.min.css' );
		static::instance()->addScript( '/public/plugins/nvd3/lib/d3.v3.js' );
		static::instance()->addScript( '/public/plugins/nvd3/nv.d3.js' );
	}
