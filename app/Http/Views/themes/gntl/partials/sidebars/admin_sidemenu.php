<ul class="nav side-menu">
    ...
    <li><a href="<?php echo Url('admin/applicants') ?>"><i class="fa fa-table"></i> Applicants <span class="fa fa-chevron-down"></span></a></li>
    <li><a href="<?php echo Url('admin/teachers') ?>"><i class="fa fa-table"></i> Teachers <span class="fa fa-chevron-down"></span></a></li>
